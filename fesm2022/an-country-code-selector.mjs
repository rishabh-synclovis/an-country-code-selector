...
class CountrySelectComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.30", type: CountrySelectComponent, isStandalone: true, selector: "ngx-country-select", inputs: { defaultIso2: "defaultIso2", disabled: "disabled", placeholder: "placeholder", customSearch: "customSearch", showDialCode: "showDialCode" }, outputs: { countryChange: "countryChange" }, host: { listeners: { "document:click": "onDocumentClick($event)", "keydown.escape": "onEscape()" } }, providers: [
        ...
        ], ngImport: i0, template: "<div class=\"ngx-ccp\" [class.ngx-ccp--disabled]=\"disabled\" [class.ngx-ccp--dial-code]=\"showDialCode\">\n  <button\n    type=\"button\"\n    class=\"ngx-ccp__trigger\"\n    [attr.aria-expanded]=\"isOpen\"\n    [disabled]=\"disabled\"\n    (click)=\"toggle()\"\n  >\n    <ng-container *ngIf=\"selected; else placeholderTpl\">\n      <span class=\"ngx-ccp__flag\">{{ selected.flag }}</span>\n      <span class=\"ngx-ccp__dial\" *ngIf=\"showDialCode\">{{ selected.dialCode }}</span>\n    </ng-container>\n    <ng-template #placeholderTpl>\n      <span class=\"ngx-ccp__placeholder\">Select country</span>\n    </ng-template>\n    <span class=\"ngx-ccp__caret\" aria-hidden=\"true\">\u25BE</span>\n  </button>\n\n  <div class=\"ngx-ccp__panel\" *ngIf=\"isOpen\">\n    <ng-content select=\"[ngxCountrySearch]\" *ngIf=\"customSearch\"></ng-content>\n    <input\n      *ngIf=\"!customSearch\"\n      type=\"text\"\n      class=\"ngx-ccp__search\"\n      [placeholder]=\"placeholder\"\n      [ngModel]=\"searchTerm\"\n      (ngModelChange)=\"onSearch($event)\"\n      autocomplete=\"off\"\n    />\n    <ul class=\"ngx-ccp__list\" role=\"listbox\">\n      <li\n        *ngFor=\"let country of filtered\"\n        class=\"ngx-ccp__option\"\n        [class.ngx-ccp__option--active]=\"selected?.iso2 === country.iso2\"\n        role=\"option\"\n        (click)=\"select(country)\"\n      >\n        <span class=\"ngx-ccp__flag\">{{ country.flag }}</span>\n        <span class=\"ngx-ccp__name\">{{ country.name }}</span>\n        <span class=\"ngx-ccp__dial\">{{ country.dialCode }}</span>\n      </li>\n      <li class=\"ngx-ccp__empty\" *ngIf=\"filtered.length === 0\">No matches</li>\n    </ul>\n  </div>\n</div>\n", styles: [".ngx-ccp{position:relative;display:inline-block;font-family:var(--ngx-ccp-font-family, inherit);font-size:var(--ngx-ccp-font-size, 14px);color:var(--ngx-ccp-text-color, inherit)}.ngx-ccp--disabled{opacity:var(--ngx-ccp-disabled-opacity, .5);pointer-events:none}.ngx-ccp__trigger{display:inline-flex;align-items:center;gap:var(--ngx-ccp-trigger-gap, 6px);padding:var(--ngx-ccp-trigger-padding, 6px 10px);border:var(--ngx-ccp-trigger-border, 1px solid #ccc);border-radius:var(--ngx-ccp-trigger-radius, 6px);background:var(--ngx-ccp-trigger-bg, #fff);color:inherit;cursor:pointer;min-width:var(--ngx-ccp-trigger-min-width, 46px)}.ngx-ccp--dial-code .ngx-ccp__trigger{min-width:var(--ngx-ccp-trigger-dial-min-width, 90px)}.ngx-ccp__placeholder{color:var(--ngx-ccp-placeholder-color, #888)}.ngx-ccp__caret{margin-left:var(--ngx-ccp-caret-margin-left, auto);font-size:var(--ngx-ccp-caret-size, 10px);color:var(--ngx-ccp-caret-color, #888)}.ngx-ccp__panel{position:absolute;top:calc(100% + var(--ngx-ccp-panel-gap, 4px));left:0;z-index:var(--ngx-ccp-panel-z-index, 1000);width:var(--ngx-ccp-panel-width, 260px);max-height:var(--ngx-ccp-panel-max-height, 320px);display:flex;flex-direction:column;background:var(--ngx-ccp-panel-bg, #fff);border:var(--ngx-ccp-panel-border, 1px solid #ccc);border-radius:var(--ngx-ccp-panel-radius, 6px);box-shadow:var(--ngx-ccp-panel-shadow, 0 4px 16px rgba(0, 0, 0, .12));overflow:hidden}.ngx-ccp__search{padding:var(--ngx-ccp-search-padding, 8px 10px);border:none;border-bottom:var(--ngx-ccp-search-border-bottom, 1px solid #eee);outline:none;font-size:var(--ngx-ccp-search-font-size, 14px);background:var(--ngx-ccp-search-bg, transparent);color:inherit}.ngx-ccp__list{list-style:none;margin:0;padding:var(--ngx-ccp-list-padding, 4px 0);overflow-y:auto}.ngx-ccp__option{display:flex;align-items:center;gap:var(--ngx-ccp-option-gap, 8px);padding:var(--ngx-ccp-option-padding, 6px 10px);cursor:pointer}.ngx-ccp__option:hover,.ngx-ccp__option--active{background:var(--ngx-ccp-option-hover-bg, #f0f4ff)}.ngx-ccp__name{flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ngx-ccp__dial{color:var(--ngx-ccp-dial-color, #666)}.ngx-ccp__empty{padding:var(--ngx-ccp-empty-padding, 10px);color:var(--ngx-ccp-placeholder-color, #888);text-align:center}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i2.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i3.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i3.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i3.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.30", ngImport: i0, type: CountrySelectComponent, decorators: [{
            ...
            args: [{ selector: 'ngx-country-select', standalone: true, imports: [CommonModule, FormsModule], changeDetection: ChangeDetectionStrategy.OnPush, providers: [
                    ...
                    }, template: "<div class=\"ngx-ccp\" [class.ngx-ccp--disabled]=\"disabled\" [class.ngx-ccp--dial-code]=\"showDialCode\">\n  <button\n    type=\"button\"\n    class=\"ngx-ccp__trigger\"\n    [attr.aria-expanded]=\"isOpen\"\n    [disabled]=\"disabled\"\n    (click)=\"toggle()\"\n  >\n    <ng-container *ngIf=\"selected; else placeholderTpl\">\n      <span class=\"ngx-ccp__flag\">{{ selected.flag }}</span>\n      <span class=\"ngx-ccp__dial\" *ngIf=\"showDialCode\">{{ selected.dialCode }}</span>\n    </ng-container>\n    <ng-template #placeholderTpl>\n      <span class=\"ngx-ccp__placeholder\">Select country</span>\n    </ng-template>\n    <span class=\"ngx-ccp__caret\" aria-hidden=\"true\">\u25BE</span>\n  </button>\n\n  <div class=\"ngx-ccp__panel\" *ngIf=\"isOpen\">\n    <ng-content select=\"[ngxCountrySearch]\" *ngIf=\"customSearch\"></ng-content>\n    <input\n      *ngIf=\"!customSearch\"\n      type=\"text\"\n      class=\"ngx-ccp__search\"\n      [placeholder]=\"placeholder\"\n      [ngModel]=\"searchTerm\"\n      (ngModelChange)=\"onSearch($event)\"\n      autocomplete=\"off\"\n    />\n    <ul class=\"ngx-ccp__list\" role=\"listbox\">\n      <li\n        *ngFor=\"let country of filtered\"\n        class=\"ngx-ccp__option\"\n        [class.ngx-ccp__option--active]=\"selected?.iso2 === country.iso2\"\n        role=\"option\"\n        (click)=\"select(country)\"\n      >\n        <span class=\"ngx-ccp__flag\">{{ country.flag }}</span>\n        <span class=\"ngx-ccp__name\">{{ country.name }}</span>\n        <span class=\"ngx-ccp__dial\">{{ country.dialCode }}</span>\n      </li>\n      <li class=\"ngx-ccp__empty\" *ngIf=\"filtered.length === 0\">No matches</li>\n    </ul>\n  </div>\n</div>\n", styles: [".ngx-ccp{position:relative;display:inline-block;font-family:var(--ngx-ccp-font-family, inherit);font-size:var(--ngx-ccp-font-size, 14px);color:var(--ngx-ccp-text-color, inherit)}.ngx-ccp--disabled{opacity:var(--ngx-ccp-disabled-opacity, .5);pointer-events:none}.ngx-ccp__trigger{display:inline-flex;align-items:center;gap:var(--ngx-ccp-trigger-gap, 6px);padding:var(--ngx-ccp-trigger-padding, 6px 10px);border:var(--ngx-ccp-trigger-border, 1px solid #ccc);border-radius:var(--ngx-ccp-trigger-radius, 6px);background:var(--ngx-ccp-trigger-bg, #fff);color:inherit;cursor:pointer;min-width:var(--ngx-ccp-trigger-min-width, 46px)}.ngx-ccp--dial-code .ngx-ccp__trigger{min-width:var(--ngx-ccp-trigger-dial-min-width, 90px)}.ngx-ccp__placeholder{color:var(--ngx-ccp-placeholder-color, #888)}.ngx-ccp__caret{margin-left:var(--ngx-ccp-caret-margin-left, auto);font-size:var(--ngx-ccp-caret-size, 10px);color:var(--ngx-ccp-caret-color, #888)}.ngx-ccp__panel{position:absolute;top:calc(100% + var(--ngx-ccp-panel-gap, 4px));left:0;z-index:var(--ngx-ccp-panel-z-index, 1000);width:var(--ngx-ccp-panel-width, 260px);max-height:var(--ngx-ccp-panel-max-height, 320px);display:flex;flex-direction:column;background:var(--ngx-ccp-panel-bg, #fff);border:var(--ngx-ccp-panel-border, 1px solid #ccc);border-radius:var(--ngx-ccp-panel-radius, 6px);box-shadow:var(--ngx-ccp-panel-shadow, 0 4px 16px rgba(0, 0, 0, .12));overflow:hidden}.ngx-ccp__search{padding:var(--ngx-ccp-search-padding, 8px 10px);border:none;border-bottom:var(--ngx-ccp-search-border-bottom, 1px solid #eee);outline:none;font-size:var(--ngx-ccp-search-font-size, 14px);background:var(--ngx-ccp-search-bg, transparent);color:inherit}.ngx-ccp__list{list-style:none;margin:0;padding:var(--ngx-ccp-list-padding, 4px 0);overflow-y:auto}.ngx-ccp__option{display:flex;align-items:center;gap:var(--ngx-ccp-option-gap, 8px);padding:var(--ngx-ccp-option-padding, 6px 10px);cursor:pointer}.ngx-ccp__option:hover,.ngx-ccp__option--active{background:var(--ngx-ccp-option-hover-bg, #f0f4ff)}.ngx-ccp__name{flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ngx-ccp__dial{color:var(--ngx-ccp-dial-color, #666)}.ngx-ccp__empty{padding:var(--ngx-ccp-empty-padding, 10px);color:var(--ngx-ccp-placeholder-color, #888);text-align:center}\n"] }]
